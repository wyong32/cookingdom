export const guides = [
  {
    ...
    sidebarData: {
      ...
      levelInfoHtml:
        '<h3>First Pizza</h3><p><strong>Difficulty:</strong> Easy</p><p><strong>Est. Time:</strong> 1 minute</p><p><strong>Reward:</strong> 3 Stars</p>',
      featuredGuides: [
        {
...
<p>In Level 1 of Cookingdom, players learn how to make and serve pizza, one of the most basic dishes in the game. This level focuses on familiarizing players with the cooking process, ingredient preparation, and the basic rhythm of restaurant operation.</p>
<h2>Level 1 Goal</h2>
<p>You will be required to make and serve the first pizza to a customer. Making pizza involves several steps, including preparing ingredients, baking, and serving. The goal is to satisfy customer needs quickly and accurately to complete the task.</p>
<h2>Pizza Making Process</h2>
<h3>Prepare Pizza Ingredients:</h3>
<p>First, gather the basic ingredients: pizza base, tomato sauce, cheese, and other toppings (like sausage, mushrooms).</p>
<ul>
  <li><strong>Pizza Base:</strong> Grab a pizza base from the ingredient area.</li>
  <li><strong>Tomato Sauce:</strong> Spread tomato sauce evenly on the base.</li>
  <li><strong>Cheese:</strong> Sprinkle cheese, ensuring even coverage.</li>
</ul>
<h3>Add Toppings:</h3>
<p>In Level 1, toppings are simple. Use basic ones like sausage or mushrooms.</p>
<ul>
  <li>Drag toppings onto the pizza, ensuring even distribution. This enhances flavor and customer satisfaction.</li>
</ul>
<h3>Bake the Pizza:</h3>
<p>Place the prepared pizza into the oven.</p>
<p><strong>Note:</strong> Baking time is crucial. Overbaking burns the pizza; underbaking leaves it raw.</p>
<p>Monitor the pizza's progress closely during baking to ensure perfect color and texture.</p>
<h3>Check Pizza Doneness:</h3>
<p>Observe the pizza's appearance. When it turns golden brown and smells fragrant, it's ready.</p>
<p>Overbaked pizza becomes charred and tastes bad, potentially dissatisfying customers.</p>
<h3>Serve the Pizza:</h3>
<p>Remove the baked pizza from the oven and immediately deliver it to the customer's table.</p>
<p>Timing is important: Long waits decrease customer satisfaction, affecting your score and rewards.</p>
<h2>Tips and Tricks</h2>
<ul>
  <li><strong>Time Management:</strong> Learn to manage time, especially with cooking and prep. Precise oven control is needed.</li>
  <li><strong>Prepare Ingredients in Advance:</strong> While waiting for the pizza to bake, prepare other ingredients or clean the kitchen. Prep ahead for faster serving.</li>
  <li><strong>Oven Operation:</strong> Familiarize yourself with the oven. Each food has different baking times; master them.</li>
  <li><strong>Customer Patience:</strong> Long waits decrease patience and scores. Speed up service.</li>
  <li><strong>Practice Multitasking:</strong> While baking, prep other items or clean to improve efficiency. Later levels have more customers and dishes, so practice helps.</li>
</ul>
<h2>Summary</h2>
<p>Making the first pizza is an introductory task in Cookingdom. It familiarizes you with cooking and serving basics, ingredient management, cooking time control, and customer needs. The goal is to understand basic time management and preparation skills for more complex levels ahead.</p>
<p>Completing Level 1 grants coins and score rewards, unlocking more kitchen equipment and recipes for a richer game experience.</p>`,
  },

  {
    ...
    sidebarData: {
      ...
      levelInfoHtml:
        '<h3>Fried Potatoes</h3><p><strong>Difficulty:</strong> Easy</p><p><strong>Est. Time:</strong> 2 minutes</p><p><strong>Reward:</strong> 3 Stars</p>',
      featuredGuides: [
        {
          id: 'cookingdom-game-level-1',
        ...
        },
        {
          ...
          title: 'Cookingdom Level 3 Rolled Ice-Cream Walkthrough',
...
<p>Completing Level 3 unlocks more recipes and equipment, preparing you for higher difficulty levels.</p>`,
...

  {
    id: 'cookingdom-game-level-3',
    title: 'Cookingdom Level 3 Rolled Ice-Cream Walkthrough',
    pageTitle: 'Cookingdom Level 3 Rolled Ice-Cream Walkthrough',
    ...
    sidebarData: {
      ...
      levelInfoHtml:
        '<h3>Rolled Ice Cream</h3><p><strong>Difficulty:</strong> Moderate</p><p><strong>Est. Time:</strong> 3 minutes</p><p><strong>Reward:</strong> 3 Stars</p>',
      featuredGuides: [
        {
          id: 'cookingdom-game-level-2',
          title: 'Cookingdom Level 2 Fried Potatos Walkthrough',
        ...
        },
        {
          ...
          title: 'Cookingdom-Level-4-Simple-Salad-Walkthrough',
...
<p>Cookingdom Level 3 elevates the gameplay with the unique technique of making rolled ice cream. You’ll learn to balance freezing time, rolling skills, and toppings to craft the perfect treat. With practice, you’ll be able to serve quickly and beautifully under time pressure. Get ready for more advanced dishes in future levels!</p>`,
...

  {
    id: 'cookingdom-game-level-4',
    title: 'Cookingdom Level 4 Simple Salad Walkthrough',
    pageTitle: 'Cookingdom Level 4 Simple Salad Walkthrough',
    ...
    sidebarData: {
      ...
      levelInfoHtml:
        '<h3>Simple Salad</h3><p><strong>Difficulty:</strong> Easy</p><p><strong>Est. Time:</strong> 2–3 minutes</p><p><strong>Reward:</strong> 3 Stars</p>',
      featuredGuides: [
        {
          id: 'cookingdom-game-level-3',
          title: 'Cookingdom Level 3 Rolled Ice-Cream Walkthrough',
        ...
        },
        {
          ...
          title: 'Cookingdom Level 5 Grilled Fish Walkthrough',
...
<p>Cookingdom Level 4 is all about speed and accuracy. Making a Simple Salad might be basic, but with fast-paced orders and specific requests, you’ll need to manage ingredients, prep time, and service flow efficiently. Get ready for more challenging dishes in the next levels!</p>`,
...

  {
    id: 'cookingdom-game-level-5',
    title: 'Cookingdom Level 5 Grilled Fish Walkthrough',
    pageTitle: 'Cookingdom Level 5 Grilled Fish Walkthrough',
    ...
    sidebarData: {
      ...
      levelInfoHtml:
        '<h3>Grilled Fish</h3><p><strong>Difficulty:</strong> Medium</p><p><strong>Est. Time:</strong> 3 minutes</p><p><strong>Reward:</strong> 4 Stars</p>',
      featuredGuides: [
        {
          id: 'cookingdom-game-level-4',
          title: 'Cookingdom Level 4 Simple Salad Walkthrough',
        ...
        },
        {
          ...
          title: 'Cookingdom Level 6 Cafe Espresso Walkthrough',
...
`,
...

  {
    id: 'cookingdom-game-level-6',
    title: 'Cookingdom Level 6 Cafe Espresso Walkthrough',
    pageTitle: 'Cookingdom Level 6 Cafe Espresso Walkthrough',
    ...
    sidebarData: {
      ...
      levelInfoHtml:
        '<h3>Café Espresso</h3><p><strong>Difficulty:</strong> Medium</p><p><strong>Est. Time:</strong> 1.5 minutes</p><p><strong>Reward:</strong> 4 Stars</p>',
      featuredGuides: [
        {
          id: 'cookingdom-game-level-5',
          title: 'Cookingdom Level 5 Grilled Fish Walkthrough',
        ...
        },
        {
          ...
          title: 'Cookingdom Level 7 Sunny Eggs Walkthrough',
...
`,
  },
  {
    id: 'cookingdom-game-level-7',
    title: 'Cookingdom Level 7 Sunny Eggs Walkthrough',
    pageTitle: 'Cookingdom Level 7 Sunny Eggs Walkthrough',
    ...
    sidebarData: {
      ...
      levelInfoHtml:
        '<h3>Sunny Eggs</h3><p><strong>Difficulty:</strong> Easy</p><p><strong>Est. Time:</strong> 1 minute</p><p><strong>Reward:</strong> 3 Stars</p>',
      featuredGuides: [
        {
          id: 'cookingdom-game-level-6',
          title: 'Cookingdom Level 6 Cafe Espresso Walkthrough',
    ...
    sidebarData: {
      ...
      featuredGuides: [
        ...
        },
        {
          ...
          title: 'Cookingdom Level 9 Spaghetti Walkthrough',
          imageUrl: '/images/guides_06.webp',
          detailsRoute: {
            name: 'guide-detail',
...
<p>By focusing on perfecting the BBQ meat, creating a flavorful sauce, and managing your kitchen efficiently, you'll impress your customers and earn top ratings. The combination of tender BBQ, savory sides, and smoky flavor will keep your customers coming back for more.</p>
...

  {
    id: 'cookingdom-game-level-9',
    title: 'Cookingdom Level 9 Spaghetti Walkthrough',
    pageTitle: 'Cookingdom Level 9 Spaghetti Walkthrough',
    ...
    sidebarData: {
      ...
      levelInfoHtml:
        '<h3>Spaghetti</h3><p><strong>Difficulty:</strong> Medium</p><p><strong>Est. Time:</strong> 2.5 minutes</p><p><strong>Reward:</strong> 5 Stars</p>',
      featuredGuides: [
        {
          id: 'cookingdom-game-level-8',
          title: 'Cookingdom Level 8 Texas BBQ Walkthrough',
        ...
        },
        {
          ...
          title: 'Cookingdom Level 10 Salmon Sushi Walkthrough',
...
`,
...

  {
    id: 'cookingdom-game-level-10',
    title: 'Cookingdom Level 10 Salmon Sushi Walkthrough',
    pageTitle: 'Cookingdom Level 10 Salmon Sushi Walkthrough',
    ...
    sidebarData: {
      ...
      featuredGuides: [
        ...
        },
        {
          ...
          title: 'Cookingdom Level 11 PopCorn Walkthrough',
...
<p>Mastering sushi will set you up for success in future levels, as customers will expect more complex and delicate dishes. With practice, you'll be able to create perfect sushi rolls that keep your customers happy and your restaurant thriving.</p>`,
...

  {
    id: 'cookingdom-game-level-11',
    title: 'Cookingdom Level 11 PopCorn Walkthrough',
    pageTitle: 'Cookingdom Level 11 PopCorn Walkthrough',
    ...
    sidebarData: {
      ...
      featuredGuides: [
        ...
        },
        {
          ...
          title: 'Cookingdom Level 12 Ramen Walkthrough',
...
`,
  },
  {
    id: 'cookingdom-game-level-12',
    title: 'Cookingdom Level 12 Ramen Walkthrough',
    pageTitle: 'Cookingdom Level 12 Ramen Walkthrough',
    ...
    sidebarData: {
      ...
      featuredGuides: [
        ...
        },
        {
          ...
          title: 'Cookingdoml Level 13 Hotdog Walkthrough',
...
`,
...

  {
    id: 'cookingdom-game-level-13',
    title: 'Cookingdoml Level 13 Hotdog Walkthrough',
    pageTitle: 'Cookingdoml Level 13 Hotdog Walkthrough',
    ...
    sidebarData: {
      ...
      featuredGuides: [
        ...
        },
        {
          ...
          title: 'Cookingdom Level 14 Salmon With Minestrone Walkthrough',
...
`,
  },
  {
    id: 'cookingdom-game-level-14',
    title: 'Cookingdom Level 14 Salmon With Minestrone Walkthrough',
    pageTitle: 'Cookingdom Level 14 Salmon With Minestrone Walkthrough',
    ...
    sidebarData: {
      ...
      levelInfoHtml:
        '<h3>Salmon w/ Minestrone</h3><p><strong>Difficulty:</strong> Medium</p><p><strong>Approx. Time:</strong> 4 minutes</p><p><strong>Reward:</strong> 5 Stars</p>', // Estimation
      featuredGuides: [
        {
          id: 'cookingdom-game-level-13',
          title: 'Cookingdoml Level 13 Hotdog Walkthrough',
        ...
        },
        {
          ...
          title: 'Cookingdom Level 15 Chicken Fried Walkthrough',
...
<ul>
    ...
    <li>
        <strong>Timing is Everything:</strong> Managing the cooking time for both the salmon and the soup at the same time can be challenging. Use multitasking skills to ensure the salmon doesn't overcook while the soup finishes simmering.
...
`,
  ...
  {
    // Add entry for Level 15
    id: 'cookingdom-game-level-15',
    title: 'Cookingdom Level 15 Chicken Fried Walkthrough',
    pageTitle: 'Cookingdom Level 15 Chicken Fried Walkthrough',
    ...
    sidebarData: {
      ...
      featuredGuides: [
        ...
        },
        {
          ...
          title: 'Cookingdom Level 17 Cafe Macchiato Walkthrough',
...
`,
...

  {
    ...
    id: 'cookingdom-game-level-17',
    title: 'Cookingdom Level 17 Cafe Macchiato Walkthrough',
    pageTitle: 'Cookingdom Level 17 Cafe Macchiato Walkthrough',
    ...
    sidebarData: {
      ...
      featuredGuides: [
        ...
        },
        {
          ...
          title: 'Cookingdom Level 18 Ratatouille Walkthrough',
...
`,
  ...
  {
    // Add entry for Level 18
    id: 'cookingdom-game-level-18',
    title: 'Cookingdom Level 18 Ratatouille Walkthrough',
    pageTitle: 'Cookingdom Level 18 Ratatouille Walkthrough',
    ...
    sidebarData: {
      ...
      levelInfoHtml:
        '<h3>Ratatouille</h3><p><strong>Difficulty:</strong> Medium</p><p><strong>Approx Time:</strong> 4 mins</p><p><strong>Rewards:</strong> 5 Stars</p>', // Estimated
      featuredGuides: [
        {
          id: 'cookingdom-game-level-17',
          title: 'Cookingdom Level 17 Cafe Macchiato Walkthrough',
        ...
        },
        {
          ...
          title: 'Cookingdom Level 19 Pumpkin Pie Walkthrough',
...
<ul>
    ...
    <li>
        <strong>Cook the Vegetables:</strong> The vegetables will need to be sautéed in a flavorful base of olive oil, garlic, and herbs. It's important to cook the vegetables just right to keep them tender yet still holding their shape.
    </li>
    <li>
...
<ol>
    ...
    <li>
        ...
        <p>Once the vegetables are tender and the sauce is thick and flavorful, it's time to plate the Ratatouille. Arrange the cooked vegetables neatly in the center of the plate and spoon some of the sauce over them.</p>
        <p><strong>Tip:</strong> You can garnish the Ratatouille with fresh herbs like basil or parsley for a burst of color and extra flavor.</p>
    </li>
    <li>
...
<ul>
    <li>
        ...
        <p>The key to perfectly cooked Ratatouille is evenly sliced vegetables. Using a mandoline slicer will help ensure the slices are uniform and cook evenly.</p>
        <p><strong>Tip:</strong> Take your time to slice the vegetables neatly, as this will significantly impact the final presentation and texture.</p>
    </li>
    <li>
    ...
    <li>
        <h3>Perfect the Sauce:</h3>
        <p>The sauce in Ratatouille is simple but flavorful. Make sure it's well-seasoned with fresh herbs, and don't forget to simmer it gently to allow the flavors to develop.</p>
        <p><strong>Tip:</strong> If the sauce is too thin, let it cook for a few extra minutes until it thickens. If it's too thick, add a little water or vegetable broth to reach the desired consistency.</p>
    </li>
    <li>
...
`,
  ...
  {
    // Add entry for Level 19
    id: 'cookingdom-game-level-19',
    title: 'Cookingdom Level 19 Pumpkin Pie Walkthrough',
    pageTitle: 'Cookingdom Level 19 Pumpkin Pie Walkthrough',
    ...
    sidebarData: {
      ...
      levelInfoHtml:
        '<h3>Pumpkin Pie</h3><p><strong>Difficulty:</strong> Medium</p><p><strong>Approx. Time:</strong> 4 mins</p><p><strong>Rewards:</strong> 5 Stars</p>', // Estimate
      featuredGuides: [
        {
          id: 'cookingdom-game-level-18',
          title: 'Cookingdom Level 18 Ratatouille Walkthrough',
    ...
    sidebarData: {
      ...
      featuredGuides: [
        ...
        },
        {
          ...
          title: 'Cookingdom Level 21 Boba Milk Tea Walkthrough',
...
`,
  },
  {
    ...
    id: 'cookingdom-game-level-21',
    title: 'Cookingdom Level 21 Boba Milk Tea Walkthrough',
    pageTitle: 'Cookingdom Level 21 Boba Milk Tea Walkthrough',
    ...
    sidebarData: {
      ...
      levelInfoHtml:
        '<h3>Boba Milk Tea</h3><p><strong>Difficulty:</strong> Medium</p><p><strong>Approx. Time:</strong> 3 mins</p><p><strong>Rewards:</strong> 5 Stars</p>', // Estimate
      featuredGuides: [
        {
          id: 'cookingdom-game-level-20',
          title: 'Cookingdom Level 20 Roast TurkeyWalkthrough',
        ...
        },
        {
          ...
          title: 'Cookingdom Level 22 Easy Smoothie Walkthrough',
...
`,
  },
  {
    ...
    id: 'cookingdom-game-level-22',
    title: 'Cookingdom Level 22 Easy Smoothie Walkthrough',
    pageTitle: 'Cookingdom Level 22 Easy Smoothie Walkthrough',
    ...
    sidebarData: {
      ...
      levelInfoHtml:
        '<h3>Easy Smoothie</h3><p><strong>Difficulty:</strong> Easy</p><p><strong>Approx. Time:</strong> 2 mins</p><p><strong>Rewards:</strong> 5 Stars</p>', // Estimate
      featuredGuides: [
        {
          id: 'cookingdom-game-level-21',
          title: 'Cookingdom Level 21 Boba Milk Tea Walkthrough',
        ...
        },
        {
          ...
          title: 'Cookingdom Level 23 Yule Log Cake Walkthrough',
...
`,
  },
  {
    ...
    id: 'cookingdom-game-level-23',
    title: 'Cookingdom Level 23 Yule Log Cake Walkthrough',
    pageTitle: 'Cookingdom Level 23 Yule Log Cake Walkthrough',
    ...
    sidebarData: {
      ...
      levelInfoHtml:
        '<h3>Yule Log Cake</h3><p><strong>Difficulty:</strong> High</p><p><strong>Approx. Time:</strong> 5 mins</p><p><strong>Rewards:</strong> 5 Stars</p>', // Estimate
      featuredGuides: [
        {
          id: 'cookingdom-game-level-22',
          title: 'Cookingdom Level 22 Easy Smoothie Walkthrough',
        ...
        },
        {
          ...
          title: 'Cookingdom Level 24 Beef Pho Walkthrough',
...
`,
  },
  {
    ...
    id: 'cookingdom-game-level-24',
    title: 'Cookingdom Level 24 Beef Pho Walkthrough',
    pageTitle: 'Cookingdom Level 24 Beef Pho Walkthrough',
    pageSubtitle:
    ...
    sidebarData: {
      ...
      levelInfoHtml:
        '<h3>Beef Pho</h3><p><strong>Difficulty:</strong> Medium</p><p><strong>Approx. Time:</strong> 4 mins</p><p><strong>Rewards:</strong> 5 Stars</p>', // Estimate
      featuredGuides: [
        {
          id: 'cookingdom-game-level-23',
          title: 'Cookingdom Level 23 Yule Log Cake Walkthrough',
        ...
        },
        {
          ...
          title: 'Cookingdom Level 25 Pizza Walkthrough',
...
<ul>
    ...
    <li>Cook the beef slices to the perfect doneness.</li>
    <li>Assemble the pho with fresh herbs, bean sprouts, and lime.</li>
    <li>Serve the pho while it’s hot and flavorful.</li>
</ul>

<h2 id="steps">Step-by-Step Guide to Master Beef Pho</h2>
<ol>
    <li>
    ...
    <li>
        <h3>Assemble the Pho</h3>
        <p>Once the broth is ready, and the noodles are cooked, it’s time to assemble the pho. Place the noodles into the bowl first, then layer the raw beef slices on top. Pour the hot broth over the beef, allowing the heat of the broth to cook the beef slices.</p>
        <p><strong>Tip:</strong> Be sure to pour the broth gently over the beef so it cooks evenly, but don’t let it sit for too long or the beef will overcook.</p>
    </li>
    <li>
    ...
    <li>
        <h3>Serve the Pho</h3>
        <p>Serve the pho while it’s hot, ensuring the beef is slightly pink in the center and perfectly tender. The hot broth will continue to cook the beef as your customer enjoys it.</p>
        <p><strong>Tip:</strong> Make sure the broth is steaming and aromatic, as the fragrance is a huge part of the pho experience.</p>
    </li>
</ol>

<h2 id="tips">Pro Tips for Level 24 Success</h2>
<ul>
    <li>
        <h3>Get the Broth Right</h3>
        <p>The broth is the heart of any pho. Simmer it for as long as the game allows, and be sure to balance the spices perfectly.</p>
        <p><strong>Tip:</strong> If the broth tastes too strong, you can dilute it with a little water; if it’s too weak, simmer it longer.</p>
    </li>
    <li>
    ...
    <li>
        ...
        <p>The beef slices should be paper-thin to cook quickly in the hot broth. Use a sharp knife for the best results. Freezing the beef beforehand makes it easier to cut thin slices.</p>
    </li>
    <li>
        <h3>Customer Preferences</h3>
        <p>Some customers may ask for extra herbs or sriracha to spice things up. Always check their preferences and add extra toppings when requested.</p>
    </li>
</ul>
...
`,
  },
  {
    ...
    id: 'cookingdom-game-level-25',
    title: 'Cookingdom Level 25 Pizza Walkthrough',
    pageTitle: 'Cookingdom Level 25 Pizza Walkthrough',
    ...
    sidebarData: {
      ...
      levelInfoHtml:
        '<h3>Pizza</h3><p><strong>Difficulty:</strong> Medium</p><p><strong>Approx. Time:</strong> 4 mins</p><p><strong>Rewards:</strong> 5 Stars</p>', // Estimate
      featuredGuides: [
        {
          id: 'cookingdom-game-level-24',
          title: 'Cookingdom Level 24 Beef Pho Walkthrough',
        ...
        },
        {
          ...
          title: 'Cookingdom Level 26 Smoothie Walkthrough',
...
<ul>
    ...
    <li>Add the right amount of cheese and toppings.</li>
    <li>Bake the pizza to a crispy perfection.</li>
...
<ol>
    ...
    <li>
        ...
        <p>Once the dough has risen, gently punch it down to release the air. Roll the dough out on a floured surface until it reaches the desired thickness.</p>
        <p><strong>Tip:</strong> For a thinner crust, roll the dough out more. For a thicker crust, leave it a bit thicker.</p>
        <p><strong>Tip:</strong> If you’re aiming for a crispy crust, make sure the dough is slightly thinner around the edges.</p>
    </li>
    <li>
    ...
    <li>
        <h3>Add Cheese and Toppings</h3>
        <p>Once the sauce is spread evenly, it’s time to layer the pizza with cheese. Mozzarella is the most common choice for pizza, but you can also use a mix of cheeses like cheddar, parmesan, or goat cheese for extra flavor.</p>
        <p><strong>Tip:</strong> Add a generous layer of cheese to ensure a cheesy, gooey result.</p>
        <p>After the cheese, add your choice of toppings. You can go traditional with pepperoni, mushrooms, and green peppers, or get creative with sausage, onions, or even pineapple.</p>
        <p><strong>Tip:</strong> Make sure the toppings are evenly distributed for a balanced bite in every slice.</p>
    </li>
    <li>
        <h3>Bake the Pizza</h3>
    ...
    <li>
        ...
        <p>Once the pizza is baked to perfection, remove it from the oven and let it cool for a minute or two.</p>
        <p>Use a pizza cutter to slice the pizza into perfect, even slices.</p>
        <p><strong>Tip:</strong> Serve the pizza immediately while the cheese is still gooey, and the crust is crispy.</p>
        <p>Bonus: Add a sprinkle of fresh basil or a drizzle of olive oil for extra flavor before serving.</p>
    </li>
</ol>

<h2 id="tips">Pro Tips for Level 25 Success</h2>
<ul>
    <li>
    ...
    <li>
        <h3>Perfect Dough Texture</h3>
        <p>A light, airy dough is key to a great pizza. Don’t rush the dough-making process; kneading and allowing it to rise properly will give you the best crust.</p>
        <p><strong>Tip:</strong> If the dough feels sticky, add a little more flour, but be careful not to make it too dry.</p>
    </li>
    <li>
...
`,
  },
  {
    ...
    id: 'cookingdom-game-level-26',
    title: 'Cookingdom Level 26 Smoothie Walkthrough',
    pageTitle: 'Cookingdom Level 26 Smoothie Walkthrough',
    ...
    sidebarData: {
      ...
      levelInfoHtml:
        '<h3>Smoothie</h3><p><strong>Difficulty:</strong> Easy</p><p><strong>Approx. Time:</strong> 2 mins</p><p><strong>Rewards:</strong> 5 Stars</p>', // Estimate
      featuredGuides: [
        {
          id: 'cookingdom-game-level-25',
          title: 'Cookingdom Level 25 Pizza Walkthrough',
        ...
        },
        {
          ...
          title: 'Cookingdom Level 27 Sandwich Walkthrough',
...
<ul>
    ...
    <li>Blend to the right consistency.</li>
    <li>Serve the smoothie with optional garnishes.</li>
...
<ol>
    ...
    <li>
        ...
        <p>The next step is to add your liquid base. You can choose between options like milk, almond milk, orange juice, or yogurt. The liquid helps blend the fruit smoothly and determines the final consistency.</p>
        <p><strong>Tip:</strong> If you want a creamier texture, go for yogurt or milk. If you prefer a lighter smoothie, juice or water works best.</p>
    </li>
    <li>
        ...
        <ul>
            ...
            <li>Ice to make it extra chilled and thick.</li>
            <li>Protein powder or peanut butter for a protein-packed smoothie.</li>
        </ul>
        <p><strong>Tip:</strong> Be mindful of the sweetness level; too much honey or syrup can overwhelm the natural fruit flavors.</p>
    </li>
    <li>
    ...
    <li>
        ...
        <p>To give your smoothie that professional touch, garnish it with toppings such as:</p>
         <ul>
            <li>Fresh fruit slices (like a strawberry on the rim or a slice of banana).</li>
    ...
    <li>
        ...
        <p>Once you’re satisfied with your smoothie’s taste and appearance, serve it promptly. The final product should be smooth, creamy, and delicious, with vibrant colors and a refreshing scent.</p>
    </li>
</ol>
...
<ul>
    <li>
        ...
        <p>The key to a perfect smoothie is balance. Choose fruits that pair well together, and always add just enough liquid to help the blending process without making the smoothie too runny.</p>
    </li>
    <li>
        <h3>Use Ice Sparingly</h3>
        <p>While ice can help thicken the smoothie, too much will dilute the flavor. Add just a handful of ice for a refreshing texture.</p>
    </li>
    <li>
        <h3>Customize for Customer Preferences</h3>
        <p>Some customers may prefer green smoothies or ask for specific ingredients like berries or protein powder. Be attentive to customer requests to boost your rating.</p>
    </li>
    <li>
        <h3>Watch the Blending Time</h3>
        <p>Don’t over-blend! Keep an eye on the consistency. Over-blending can make the smoothie too thin and watery.</p>
    </li>
    <li>
...
`,
  },
  {
    ...
    id: 'cookingdom-game-level-27',
    title: 'Cookingdom Level 27 Sandwich Walkthrough',
    pageTitle: 'Cookingdom Level 27 Sandwich Walkthrough',
    ...
    sidebarData: {
      ...
      levelInfoHtml:
        '<h3>Sandwich</h3><p><strong>Difficulty:</strong> Easy</p><p><strong>Approx. Time:</strong> 3 mins</p><p><strong>Rewards:</strong> 5 Stars</p>', // Estimate
      featuredGuides: [
        {
          id: 'cookingdom-game-level-26',
          title: 'Cookingdom Level 26 Smoothie Walkthrough',
        ...
        },
        {
          ...
          title: 'Cookingdom Level 28 Croissant Walkthrough',
...
<ul>
    ...
    <li>Add the vegetables for crunch and flavor.</li>
    <li>Top with condiments and extras like cheese.</li>
...
<ol>
    ...
    <li>
        ...
        <p>Now it’s time to add some flavor! Condiments such as mayonnaise, mustard, ketchup, or barbecue sauce can make your sandwich more flavorful.</p>
        <p><strong>Tip:</strong> Don’t go overboard with condiments; just enough to add moisture and flavor. You can also add cheese for an extra layer of creaminess, such as cheddar, Swiss, or American cheese.</p>
        <p><strong>Tip:</strong> If you’re adding cheese, make sure it melts slightly for the perfect gooey texture.</p>
    </li>
    <li>
        <h3>Assemble the Sandwich</h3>
        <p>Carefully assemble your sandwich by stacking the layers neatly. Start with the bottom slice of bread, add your protein, then veggies, and top it with condiments and cheese. Finally, place the top slice of bread to complete the sandwich.</p>
        <p><strong>Tip:</strong> If the sandwich is too tall, you can press it down lightly or cut it in half for easier handling.</p>
    </li>
    <li>
...
<ul>
    <li>
        ...
        <p>Freshness is key when making a sandwich. Always choose the freshest veggies and protein available to ensure a high-quality sandwich.</p>
    </li>
    <li>
        <h3>Balance the Flavors</h3>
        <p>Make sure the flavors are well-balanced. If the protein is rich (like beef), use milder condiments and veggies. If the protein is light (like turkey), you can add bolder flavors like mustard or barbecue sauce.</p>
    </li>
    <li>
        <h3>Toast for Crunch</h3>
        <p>Toasting the bread adds texture to the sandwich. A crispy sandwich can elevate the experience, especially if you’re serving it with warm, melted cheese.</p>
    </li>
    <li>
...
`,
  },
  {
    ...
    id: 'cookingdom-game-level-28',
    title: 'Cookingdom Level 28 Croissant Walkthrough',
    pageTitle: 'Cookingdom Level 28 Croissant Walkthrough',
    ...
    sidebarData: {
      ...
      levelInfoHtml:
        '<h3>Croissant</h3><p><strong>Difficulty:</strong> High</p><p><strong>Approx. Time:</strong> 6 mins</p><p><strong>Rewards:</strong> 5 Stars</p>', // Estimate
      featuredGuides: [
        {
          id: 'cookingdom-game-level-27',
          title: 'Cookingdom Level 27 Sandwich Walkthrough',
        ...
        },
        {
          ...
          title: 'Cookingdom Level 29 Matcha Bola Tea Walkthrough',
...
<ul>
    ...
    <li>Shape the croissant and allow it to rise.</li>
    <li>Bake the croissants to a golden perfection.</li>
...
<ol>
    ...
    <li>
        ...
        <p>Once the dough is laminated, roll it out one final time into a large rectangle. Cut the dough into triangles—these will be the individual croissants.</p>
        <p><strong>Tip:</strong> For the perfect croissant shape, roll the dough from the base of the triangle to the tip, ensuring the layers are rolled up tightly. You can also slightly curve the croissant into a crescent shape for a traditional look.</p>
        <p><strong>Tip:</strong> Make sure the croissants are evenly sized so they bake uniformly.</p>
    </li>
    <li>
    ...
    <li>
        ...
        <p>Preheat your oven to 375°F (190°C). Once the croissants have risen, it’s time to bake them.</p>
        <p><strong>Tip:</strong> Brush the tops with a little egg wash (a mixture of beaten egg and water) before baking. This will give your croissants a beautiful golden brown finish.</p>
        <p>Bake the croissants for about 15-20 minutes or until they’re golden and puffed up.</p>
        <p><strong>Tip:</strong> Keep an eye on the croissants as they bake; overbaking can make them dry and too crisp, while underbaking leaves them doughy.</p>
    </li>
    <li>
        <h3>Serve and Enjoy</h3>
        <p>Once the croissants are golden brown and puffed, take them out of the oven and let them cool for a minute before serving.</p>
        <p><strong>Tip:</strong> Croissants are best served fresh and warm, with a slightly crispy exterior and a soft, flaky interior. For an extra touch, you can sprinkle a little powdered sugar or serve with a side of jam or butter.</p>
    </li>
</ol>
...
<ul>
    ...
    <li>
        ...
        <p>Applying an egg wash before baking gives the croissants a golden, glossy finish. It’s also important for achieving that perfect texture.</p>
    </li>
    <li>
        <h3>Don’t Overcrowd the Baking Sheet</h3>
        <p>Make sure there is enough space between each croissant on the baking sheet. Crowding the croissants can cause them to bake unevenly and may prevent them from puffing properly.</p>
    </li>
    <li>
        <h3>Watch the Baking Time</h3>
        <p>Keep an eye on the croissants while they bake. You don’t want them to overbake and become too hard. They should be golden on the outside with a soft, airy inside.</p>
    </li>
</ul>
...
`,
  },
  {
    ...
    id: 'cookingdom-game-level-29',
    title: 'Cookingdom Level 29 Matcha Bola Tea Walkthrough',
    pageTitle: 'Cookingdom Level 29 Matcha Bola Tea Walkthrough',
    ...
    sidebarData: {
      ...
      levelInfoHtml:
        '<h3>Matcha Boba Tea</h3><p><strong>Difficulty:</strong> Medium</p><p><strong>Approx. Time:</strong> 4 mins</p><p><strong>Rewards:</strong> 4 Stars</p>', // Estimate
      featuredGuides: [
        {
          id: 'cookingdom-game-level-28',
          title: 'Cookingdom Level 28 Croissant Walkthrough',
        ...
        },
        {
          ...
          title: 'Cookingdom Level 30 Doner Kebab Walkthrough',
...
<ul>
    ...
    <li>Combine the milk to create a creamy drink.</li>
    <li>Assemble the Matcha Boba Tea.</li>
...
<ol>
    ...
    <li>
        <h3>Garnish and Serve</h3>
        <p>To complete the Matcha Boba Tea, you can add ice cubes to keep it refreshing and cool.</p>
        <p>You may also garnish with a little matcha powder on top or a decorative straw to enhance the visual appeal of the drink.</p>
        <p><strong>Tip:</strong> If you want to serve the tea in a traditional way, use a wide straw to allow the boba pearls to easily pass through.</p>
    </li>
</ol>
...
<ul>
    <li>
        ...
        <p>The texture of the boba pearls is key to making a good Matcha Boba Tea. They should be chewy, not too soft, and definitely not too hard. Ensure they are fully cooked and sweetened well.</p>
    </li>
    <li>
    ...
    <li>
        ...
        <p>Choose the right milk for your Matcha Boba Tea. For a richer, creamier texture, go for whole milk. For a lighter, dairy-free version, opt for almond or oat milk.</p>
    </li>
    <li>
        <h3>Perfect Your Stirring</h3>
        <p>Stir the matcha and milk mixture well. If not thoroughly mixed, you’ll end up with uneven flavor and clumps of matcha powder in your drink.</p>
    </li>
    <li>
        <h3>Watch the Sweetness Level</h3>
        <p>Sweeten the matcha base carefully. You want the flavor to complement the creamy milk and chewy boba. Too much sugar could make the drink overly sweet, while too little might make it too bitter.</p>
    </li>
</ul>
...
`,
  },
  {
    ...
    id: 'cookingdom-game-level-30',
    title: 'Cookingdom Level 30 Doner Kebab Walkthrough',
    pageTitle: 'Cookingdom Level 30 Doner Kebab Walkthrough',
    ...
    sidebarData: {
      ...
      levelInfoHtml:
        '<h3>Doner Kebab</h3><p><strong>Difficulty:</strong> Medium</p><p><strong>Approx. Time:</strong> 5 mins</p><p><strong>Rewards:</strong> 4 Stars</p>', // Estimate
      featuredGuides: [
        {
          id: 'cookingdom-game-level-29',
          title: 'Cookingdom Level 29 Matcha Bola Tea Walkthrough',
...
<ul>
    ...
    <li>Assemble the Doner Kebab in pita or flatbread.</li>
...
<ol>
    ...
    <li>
        <h3>Prepare the Vegetables</h3>
        <p>While the meat is cooking, you’ll need to prepare the vegetables. Typically, tomatoes, onions, and lettuce are used in a traditional Doner Kebab. You can also add pickles or cucumbers for extra crunch and flavor.</p>
        <p><strong>Tip:</strong> Slice the vegetables evenly and thinly so they can be added neatly to the kebab. Fresh, crunchy veggies are key to complementing the rich, savory meat.</p>
    </li>
    <li>
    ...
    <li>
        <h3>Assemble the Doner Kebab</h3>
        <p>Once all the ingredients are ready, it’s time to assemble the Doner Kebab. Start by placing the grilled meat in the center of a warm pita or flatbread.</p>
        <p><strong>Tip:</strong> Be sure to arrange the meat evenly so that each bite will have a balanced amount of filling.</p>
        <p>Add the sliced vegetables, layering them on top of the meat.</p>
        <p><strong>Tip:</strong> Make sure the vegetables are evenly distributed to ensure a balanced texture and flavor in every bite.</p>
        <p>Finally, drizzle your chosen sauces over the top, being careful to not overfill the kebab, which can make it messy to eat.</p>
    </li>
    <li>
...
<ul>
    ...
    <li>
        ...
        <p>The vegetables should add crunch and freshness to the kebab, so slice them thinly and use only the freshest ingredients. Fresh lettuce, onions, and tomatoes will provide the best texture and flavor.</p>
    </li>
    <li>
        <h3>Balance the Sauces</h3>
        <p>Be careful not to use too much sauce, as it can overwhelm the other flavors. A light drizzle of garlic sauce and a touch of spicy chili sauce will give your Doner Kebab the perfect balance of creaminess and heat.</p>
    </li>
    <li>
        <h3>Wrap it Well</h3>
        <p>The way you wrap the Doner Kebab matters! Make sure the pita or flatbread is securely wrapped around the filling to keep everything in place. If the wrap isn’t tight enough, the fillings may spill out when your customer tries to eat it.</p>
    </li>
    <li>
...
`,
  },
  {
    ...
    id: 'cookingdom-game-level-31',
    title: 'Cookingdom Level 31 Cafe Mocha Walkthrough',
    pageTitle: 'Cookingdom Level 31 Cafe Mocha Walkthrough',
    ...
    sidebarData: {
      ...
      levelInfoHtml:
        '<h3>Café Mocha</h3><p><strong>Difficulty:</strong> Medium</p><p><strong>Approx. Time:</strong> 4 mins</p><p><strong>Rewards:</strong> 4 Stars</p>', // Estimate
      featuredGuides: [
        {
          id: 'cookingdom-game-level-30',
          title: 'Cookingdom Level 30 Doner Kebab Walkthrough',
...
<ul>
    ...
    <li>Steam the milk for a creamy texture.</li>
    <li>Combine the ingredients into a perfect Café Mocha.</li>
...
<ol>
    ...
    <li>
        ...
        <p>Once all your ingredients are prepared, it’s time to assemble the Café Mocha.</p>
        <p>Pour the espresso into a cup, followed by the prepared chocolate syrup or powder. Stir well until the chocolate is fully mixed into the espresso.</p>
        <p><strong>Tip:</strong> Mix the espresso and chocolate thoroughly to ensure the flavor is even throughout.</p>
        <p>Then, pour the steamed milk over the chocolate-espresso mixture. Pour gently to create a smooth blend of coffee and chocolate.</p>
        <p><strong>Tip:</strong> Leave a small amount of space at the top of the cup to allow for a swirl of cream or garnish if needed.</p>
    </li>
    <li>
        <h3>Garnish and Serve</h3>
...
<ul>
    ...
    <li>
        ...
        <p>The key to a great Café Mocha is finding the right balance between the bitterness of the espresso and the sweetness of the chocolate. Adjust the amount of chocolate to your preference, but don’t let it overpower the espresso.</p>
    </li>
    <li>
        <h3>Garnish Creatively</h3>
        <p>A well-garnished Café Mocha not only tastes great but looks visually appealing. Add a swirl of whipped cream, a sprinkle of cocoa powder, or some chocolate shavings for a luxurious finish.</p>
    </li>
    <li>
        <h3>Serve Immediately</h3>
        <p>A Café Mocha is best served hot and fresh. Once assembled, serve it to your customers immediately while it’s still warm and creamy.</p>
    </li>
</ul>
...
`,
  },
  {
    ...
    sidebarData: {
      ...
      levelInfoHtml:
        '<h3>Hamburger</h3><p><strong>Difficulty:</strong> Medium</p><p><strong>Approx. Time:</strong> 4 mins</p><p><strong>Rewards:</strong> 4 Stars</p>', // Estimate
      featuredGuides: [
        {
          id: 'cookingdom-game-level-31',
          title: 'Cookingdom Level 31 Cafe Mocha Walkthrough',
...
<ul>
    ...
    <li>Toast the buns for added flavor and texture.</li>
    <li>Assemble the Hamburger with the right balance of ingredients.</li>
...
<ol>
    ...
    <li>
        ...
        <p>While the beef patty is cooking, you can prepare the toppings for the burger.</p>
        <ul>
    ...
    <li>
        <h3>Assemble the Hamburger</h3>
        <p>Once the patty is cooked, the buns are toasted, and the toppings are ready, it’s time to assemble your Hamburger.</p>
        <p>Start with the bottom bun and place the cooked beef patty in the center.</p>
        <p>Add a slice of cheese on top of the patty while it’s still hot so that it melts perfectly.</p>
        <p>Layer the lettuce, tomato, and onions on top of the patty.</p>
        <p><strong>Tip:</strong> Make sure the ingredients are evenly distributed, so every bite has a balanced combination of flavors and textures.</p>
        <p>Place the top bun over the assembled ingredients.</p>
    </li>
    <li>
...
<ul>
    <li>
        ...
        <p>The beef patty is the heart of the Hamburger, so getting it right is essential. Monitor the cooking process carefully to avoid undercooking or overcooking the patty. A well-cooked patty should be juicy and flavorful, not dry.</p>
    </li>
    <li>
        <h3>Choose the Right Cheese</h3>
        <p>Cheese is a crucial component of a Hamburger. Cheddar is the classic choice, but feel free to experiment with other varieties like Swiss or American. The cheese should melt nicely over the hot patty for the best texture.</p>
    </li>
    <li>
        <h3>Use Fresh and Crisp Toppings</h3>
        <p>Fresh lettuce and ripe tomatoes will make your Hamburger stand out. Use the freshest ingredients possible to ensure the burger is both visually appealing and tasty.</p>
    </li>
    <li>
        <h3>Toast the Buns Lightly</h3>
        <p>Lightly toasting the buns adds a crispy, golden texture and prevents them from becoming soggy from the burger's juices. Be careful not to over-toast them, as they can become too crunchy.</p>
    </li>
    <li>
        <h3>Assemble the Burger Neatly</h3>
        <p>Ensure the toppings are neatly stacked to avoid a messy burger. A well-assembled Hamburger will be easier for your customers to enjoy and will look more appealing.</p>
    </li>
</ul>
...
`,
  },
  {
    ...
    id: 'cookingdom-game-level-33',
    title: 'Cookingdom Level 33 Alaskan Steamed Lobster Walkthrough',
    pageTitle: 'Cookingdom Level 33 Alaskan Steamed Lobster Walkthrough',
    pageSubtitle:
    ...
    sidebarData: {
      ...
      levelInfoHtml:
        '<h3>Alaskan Steamed Lobster</h3><p><strong>Difficulty:</strong> High</p><p><strong>Approx. Time:</strong> 6 mins</p><p><strong>Rewards:</strong> 5 Stars</p>', // Estimate
      featuredGuides: [
        {
          id: 'cookingdom-game-level-32',
          title: 'Cookingdom Level 32 Hamburger Walkthrough',
        ...
        },
        {
          ...
          title: 'Cookingdom Level 34 King Crab Walkthrough',
...
<ul>
    ...
    <li>Prepare the butter sauce to complement the lobster.</li>
...
<ul>
    <li>
        ...
        <p>Over-steaming can make the lobster meat tough and dry. Be sure to monitor the steaming process carefully. Steaming time depends on the size of the lobster, so check the lobster’s shell color and texture to know when it’s done.</p>
    </li>
    <li>
        <h3>Make a Flavorful Butter Sauce</h3>
        <p>A well-seasoned butter sauce can enhance the flavor of the Alaskan Steamed Lobster. Garlic, lemon juice, and fresh herbs will give the sauce a fresh and flavorful kick. Be sure to melt the butter over low heat to avoid burning the garlic.</p>
    </li>
    <li>
        <h3>Serve Immediately for Best Taste</h3>
        <p>Alaskan Steamed Lobster is best served fresh and hot. Once the lobster is steamed and the butter sauce is ready, serve it immediately for the best flavor and experience.</p>
    </li>
    <li>
        <h3>Garnish Creatively</h3>
        <p>Garnishing with fresh herbs like parsley or a lemon wedge can add a touch of elegance to the presentation and enhance the overall appeal of the dish.</p>
    </li>
</ul>
...
`,
  },
  {
    ...
    id: 'cookingdom-game-level-34',
    title: 'Cookingdom Level 34 King Crab Walkthrough',
    pageTitle: 'Cookingdom Level 34 King Crab Walkthrough',
    ...
    sidebarData: {
      ...
      levelInfoHtml:
        '<h3>King Crab</h3><p><strong>Difficulty:</strong> High</p><p><strong>Approx. Time:</strong> 6 mins</p><p><strong>Rewards:</strong> 5 Stars</p>', // Estimate
      featuredGuides: [
        {
          id: 'cookingdom-game-level-33',
          title: 'Cookingdom Level 33 Alaskan Steamed Lobster Walkthrough',
        ...
        },
        {
          ...
          title: 'Cookingdom Level 35 Spaghetti With Mushroom Cream Sauce Walkthrough',
...
<ul>
    <li>Crack open the King Crab to access the meat.</li>
    <li>Cook the King Crab meat to perfection.</li>
    <li>Prepare a complementary sauce for the crab.</li>
...
<ul>
    <li>
        ...
        <p>Overcooking the King Crab can lead to dry and tough meat. Be sure to steam or boil the crab for the correct amount of time (around 8-10 minutes) to maintain its tenderness.</p>
    </li>
    <li>
        <h3>Perfect the Butter Sauce</h3>
        <p>The key to a great King Crab dish is the butter sauce. Make sure it’s rich but not overpowering. Fresh ingredients like garlic, lemon, and herbs will elevate the dish and bring out the crab’s natural sweetness.</p>
    </li>
    <li>
        <h3>Use the Right Tools to Crack the Crab</h3>
        <p>To access the sweet crab meat, make sure to use a crab cracker or specialized tools to carefully break open the shell. Don’t rush this process, as preserving the meat intact will make the dish look more professional.</p>
    </li>
    <li>
        <h3>Serve Immediately</h3>
        <p>Serve the King Crab as soon as it’s done to ensure it remains hot and fresh. The butter sauce should be warm, and the crab should be served right out of the steamer or boiling pot for the best flavor.</p>
    </li>
    <li>
        <h3>Garnish for Visual Appeal</h3>
        <p>A well-garnished dish not only looks more appetizing but adds extra layers of flavor. Fresh herbs, lemon wedges, and even a sprinkle of paprika can make the presentation pop.</p>
    </li>
</ul>
...
`,
  ...
  {
    // Add entry for Level 35
    id: 'cookingdom-game-level-35',
    title: 'Cookingdom Level 35 Spaghetti With Mushroom Cream Sauce Walkthrough',
    pageTitle: 'Cookingdom Level 35 Spaghetti With Mushroom Cream Sauce Walkthrough',
    pageSubtitle:
    ...
    sidebarData: {
      ...
      levelInfoHtml:
        '<h3>Spaghetti With Mushroom Cream Sauce</h3><p><strong>Difficulty:</strong> Medium</p><p><strong>Approx. Time:</strong> 6 mins</p><p><strong>Rewards:</strong> 4 Stars</p>',
      featuredGuides: [
        {
          id: 'cookingdom-game-level-34',
          title: 'Cookingdom Level 34 King Crab Walkthrough',
        ...
        },
        {
          ...
          title: 'Cookingdom Level 36 Indian Curry Walkthrough',
...
`,
  ...
  {
    // Add entry for Level 36
    id: 'cookingdom-game-level-36',
    title: 'Cookingdom Level 36 Indian Curry Walkthrough',
    pageTitle: 'Cookingdom Level 36 Indian Curry Walkthrough',
    ...
    sidebarData: {
      ...
      levelInfoHtml:
        '<h3>Indian Curry</h3><p><strong>Difficulty:</strong> Medium</p><p><strong>Approx. Time:</strong> 5 mins</p><p><strong>Rewards:</strong> 4 Stars</p>', // Estimate
      featuredGuides: [
        {
          id: 'cookingdom-game-level-35',
          title: 'Cookingdom Level 35 Spaghetti With Mushroom Cream Sauce Walkthrough',
...
<ul>
    ...
    <li>Simmer the curry to allow the flavors to meld.</li>
...
<ol>
    <li>
        ...
        <p>The first step to creating a great Indian Curry is gathering and preparing your ingredients. Common ingredients for an Indian curry include:</p>
        <ul>
            <li>Chicken, lamb, or vegetables (depending on the type of curry you’re preparing).</li>
            <li>Onions, garlic, and ginger for the base.</li>
    ...
    <li>
        ...
        <p>Start by heating oil in a large pan or pot. Add chopped onions, garlic, and ginger to create the aromatic base of the curry.</p>
        <p><strong>Tip:</strong> Sauté the aromatics until they are golden and fragrant. This step will build a rich flavor foundation for the curry.</p>
        <p><strong>Tip:</strong> Stir constantly to prevent the ingredients from burning.</p>
    </li>
    <li>
        <h3>Add the Spices</h3>
        <p>Once the onions, garlic, and ginger have sautéed to perfection, it’s time to add the spices.</p>
        <p>Add cumin, turmeric, coriander, garam masala, and chili powder to the pan. Let the spices cook for a minute or two to release their natural oils and deepen the flavor.</p>
        <p><strong>Tip:</strong> Be cautious with the chili powder if you prefer a milder curry. You can adjust the amount based on how spicy you want your curry to be.</p>
    </li>
    <li>
        <h3>Add the Meat or Vegetables</h3>
        <p>After the spices have been sautéed, add your choice of meat (such as chicken or lamb) or vegetables to the pan. Stir everything together to coat the ingredients with the spices.</p>
        <p><strong>Tip:</strong> Cook the meat until it’s browned on all sides. If you’re using vegetables, ensure they are tender and slightly cooked before adding the liquid.</p>
    </li>
    <li>
        <h3>Add the Sauce Base</h3>
        <p>Next, it’s time to create the curry sauce. Add tomatoes or coconut milk to the pan, depending on the type of curry you're making.</p>
        <p><strong>Tip:</strong> If you're making a creamy curry, coconut milk or heavy cream will give the sauce a smooth and velvety texture.</p>
        <p>Stir the sauce into the meat and spice mixture, ensuring all ingredients are well combined.</p>
        <p><strong>Tip:</strong> You can add a little bit of water or broth if the curry sauce is too thick.</p>
    </li>
    <li>
...
<ul>
    <li>
        ...
        <p>The right balance of spices is essential in an Indian Curry. If you’re new to using spices, it’s always good to start with a premade garam masala blend and then adjust with individual spices like cumin and turmeric.</p>
    </li>
    <li>
        <h3>Simmer to Build Flavor</h3>
        <p>Allowing the curry to simmer for a longer period gives the flavors time to meld together. Don’t rush this process—patience is key to achieving a deep, rich flavor.</p>
    </li>
    <li>
        <h3>Adjust the Heat</h3>
        <p>Be mindful of the heat level when adding chili powder. If you prefer a mild curry, use less or even omit it entirely. For more spice, increase the amount of chili powder or add fresh chilies to the mix.</p>
    </li>
    <li>
        <h3>Use Fresh Ingredients</h3>
        <p>Fresh ginger and garlic will add an extra burst of flavor to your curry. Freshly chopped vegetables and meats will also contribute to the texture and overall taste of the dish.</p>
    </li>
    <li>
        <h3>Garnish for Visual Appeal</h3>
        <p>Fresh cilantro, a sprinkle of garam masala, and a squeeze of lemon can elevate the appearance of your Indian Curry and make the dish more appetizing.</p>
    </li>
</ul>
...
`,
  },
  {
    ...
    id: 'cookingdom-game-level-37',
    title: 'Cookingdom Level 37 Kimchi Rice Walkthrough',
    pageTitle: 'Cookingdom Level 37 Kimchi Rice Walkthrough',
    ...
    sidebarData: {
      ...
      levelInfoHtml:
        '<h3>Kimchi Rice</h3><p><strong>Difficulty:</strong> Medium</p><p><strong>Approx. Time:</strong> 4 mins</p><p><strong>Rewards:</strong> 4 Stars</p>', // Estimate
      featuredGuides: [
        {
          id: 'cookingdom-game-level-36',
          title: 'Cookingdom Level 36 Indian Curry Walkthrough',
...
`,
...

  {
    ...
    id: 'cookingdom-game-level-40',
    title: 'Cookingdom Level 40 Beef Wellington Walkthrough',
    pageTitle: 'Cookingdom Level 40 Beef Wellington Walkthrough',
    ...
    sidebarData: {
      ...
      featuredGuides: [
        ...
        },
        {
          ...
          title: 'Cookingdom Level 42 Mapo Tofu Walkthrough',
...
`,
  },
  {
    ...
    id: 'cookingdom-game-level-42',
    title: 'Cookingdom Level 42 Mapo Tofu Walkthrough',
    pageTitle: 'Cookingdom Level 42 Mapo Tofu Walkthrough',
    pageSubtitle:
...
`,
  },
  {
    ...
    id: 'cookingdom-game-level-43',
    title: 'Cookingdom Level 43 Moon Cake Walkthrough',
    pageTitle: 'Cookingdom Level 43 Moon Cake Walkthrough',
    pageSubtitle:
...
`,
...

  {
    ...
    sidebarData: {
      ...
      levelInfoHtml:
        '<h3>Cookingdom Level 44 <br/> Chocolate</h3><p><strong>Difficulty:</strong> Medium</p><p><strong>Approx. Time:</strong> 2–3 mins</p><p><strong>Rewards:</strong> 3–4 Stars (Estimate)</p>',
      featuredGuides: [
        {
          id: 'cookingdom-game-level-43',
          title: 'Cookingdom Level 43 Moon Cake Walkthrough',
    ...
    detailsHtml: `
<h2 id="overview">Cookingdom Level 44 Game Overview</h2>
<p><strong>Cookingdom Level 44</strong> takes you into the world of rich chocolate-making. From melting chocolate to using molds and toppings, this level demands fast timing and attention to detail. Get ready to satisfy customers with perfectly crafted sweets!</p>

<h2 id="goal">🎯 Cookingdom Level 44 Goal</h2>
<ul>
  <li>Serve at least 28 chocolate desserts</li>
  <li>Maintain customer satisfaction above 85%</li>
  <li>Finish within 3 minutes</li>
</ul>

<h2 id="ingredients">🍫 Cookingdom Level 44 Ingredients</h2>
<ul>
  <li>Milk chocolate base</li>
  <li>Dark chocolate base</li>
  <li>Flavor infusions: mint, strawberry, caramel</li>
  <li>Chocolate molds (heart, square, swirl)</li>
  <li>Toppings: nuts, sprinkles, berries</li>
</ul>

<h2 id="steps">👨‍🍳 Cookingdom Level 44 Step-by-Step Strategy</h2>
<ol>
  <li>Choose the correct chocolate base as per customer request.</li>
  <li>Pour the melted chocolate into the selected mold.</li>
  <li>Add the correct flavor infusion if required.</li>
  <li>Top with the requested toppings before chilling.</li>
  <li>Serve quickly once set. Work on the next batch while waiting.</li>
</ol>

<h2 id="tips">🔥 Cookingdom Level 44 Pro Tips</h2>
<ul>
  <li><strong>Preheat chocolate melters:</strong> Always keep both bases warm and ready.</li>
  <li><strong>Memorize mold shapes:</strong> Familiarize yourself with the shapes to speed up selection.</li>
  <li><strong>Upgrade chillers:</strong> Faster cooling means faster servings and better combos.</li>
</ul>

<h2 id="mistakes">🚫 Common Mistakes in Level 44</h2>
<ul>
  <li>Using wrong chocolate base — always check the icon before starting.</li>
  <li>Forgetting toppings — a missed topping can ruin the whole dessert.</li>
  <li>Leaving chocolate in mold too long — delays orders and breaks combos.</li>
</ul>
`,
  },

  {
    ...
    sidebarData: {
      ...
      levelInfoHtml:
        '<h3>Cookingdom Level 45 <br/> Pastitsio</h3><p><strong>Difficulty:</strong> Medium-High</p><p><strong>Approx. Time:</strong> 3–4 mins</p><p><strong>Rewards:</strong> 3–4 Stars (Estimate)</p>',
      featuredGuides: [
        {
          id: 'cookingdom-game-level-44',
          title: 'Cookingdom Level 44 Chocolate Walkthrough',
    ...
    detailsHtml: `
<h2 id="overview">Cookingdom Level 45 Game Overview</h2>
<p><strong>Cookingdom Level 45</strong> brings a Greek classic to the table — <strong>Pastitsio</strong>. This baked pasta dish features hearty layers that test your multitasking and timing skills. Balance prep and oven usage to keep your combos going strong.</p>

<h2 id="goal">🎯 Cookingdom Level 45 Goal</h2>
<ul>
  <li>Serve at least 22 portions of Pastitsio</li>
  <li>Maintain satisfaction above 85%</li>
  <li>Complete the level in under 4 minutes</li>
</ul>

<h2 id="ingredients">🍝 Cookingdom Level 45 Ingredients</h2>
<ul>
  <li>Cooked pasta tubes (penne or macaroni)</li>
  <li>Ground meat sauce (beef or lamb)</li>
  <li>Béchamel sauce (creamy white sauce)</li>
  <li>Cheese topping (optional but boosts score)</li>
  <li>Oven for baking</li>
</ul>

<h2 id="steps">👨‍🍳 Cookingdom Level 45 Step-by-Step Strategy</h2>
<ol>
  <li>Layer cooked pasta in a baking dish.</li>
  <li>Add meat sauce on top, followed by a thick layer of béchamel.</li>
  <li>Sprinkle with cheese if requested.</li>
  <li>Bake in the oven until golden brown.</li>
  <li>Serve hot and prep the next batch during baking time.</li>
</ol>

<h2 id="tips">🔥 Cookingdom Level 45 Pro Tips</h2>
<ul>
  <li><strong>Stagger your batches:</strong> Always have one in the oven and another in prep.</li>
  <li><strong>Upgrade oven speed:</strong> Faster baking is key to keeping up with demand.</li>
  <li><strong>Memorize requests:</strong> Some customers prefer no cheese — pay close attention.</li>
</ul>

<h2 id="mistakes">🚫 Common Mistakes in Level 45</h2>
<ul>
  <li>Incorrect layer order — always follow pasta → meat → béchamel.</li>
  <li>Overbaking — can result in burnt dishes and lost points.</li>
  <li>Idle oven — keep it running to avoid lag in servings.</li>
</ul>
`,
  },

  {
    id: 'cookingdom-game-level-46',
    title: 'Cookingdom Level 46 Sweet Potato Chewy Pudding Walkthrough',
    pageTitle: 'Cookingdom Level 46 Sweet Potato Chewy Pudding Walkthrough',
    pageSubtitle:
    ...
    sidebarData: {
      ...
      levelInfoHtml:
        '<h3>Cookingdom Level 46 <br/> Sweet Potato Chewy Pudding</h3><p><strong>Difficulty:</strong> Medium</p><p><strong>Approx. Time:</strong> 3 mins</p><p><strong>Rewards:</strong> 3 Stars (Estimate)</p>',
      featuredGuides: [
        {
          id: 'cookingdom-game-level-45',
          title: 'Cookingdom Level 45 Pastitsio Walkthrough',
...
`,
...

  {
    ...
    sidebarData: {
      ...
      levelInfoHtml:
        '<h3>Cookingdom Level 47 <br/> Lunch Box</h3><p><strong>Difficulty:</strong> High</p><p><strong>Approx. Time:</strong> 3 mins</p><p><strong>Rewards:</strong> 4 Stars (Estimate)</p>',
      featuredGuides: [
        {
          id: 'cookingdom-game-level-46',
          title: 'Cookingdom Level 46 Sweet Potato Chewy Pudding Walkthrough',
        ...
        },
        {
          ...
          title: 'Cookingdom Level 48 Seafood Pasta Walkthrough',
...
<h2 id="ingredients">🍱 Cookingdom Level 47 Ingredients</h2>
<ul>
  <li>Steamed rice</li>
  <li>Protein: grilled chicken, tofu, or shrimp</li>
  <li>Vegetables: broccoli, carrots, edamame</li>
  <li>Sauces: teriyaki, sesame, or spicy</li>
  <li>Lunch box containers</li>
</ul>

<h2 id="steps">👨‍🍳 Cookingdom Level 47 Step-by-Step Strategy</h2>
<ol>
  <li>Check the customer order carefully for the correct ingredients.</li>
  <li>Fill the lunch box with rice as a base.</li>
  <li>Add the required protein and vegetable side items.</li>
  <li>Drizzle the requested sauce on top.</li>
  <li>Serve quickly and prepare the next one during animations.</li>
</ol>

<h2 id="tips">🔥 Cookingdom Level 47 Pro Tips</h2>
<ul>
  <li><strong>Group similar orders:</strong> If multiple customers want the same lunch box, batch them together.</li>
  <li><strong>Use shortcuts:</strong> Memorize the common combos to assemble faster during rushes.</li>
  <li><strong>Pre-cook proteins:</strong> Ensure all proteins are ready before customers arrive.</li>
</ul>

<h2 id="mistakes">🚫 Common Mistakes in Level 47</h2>
<ul>
  <li>Wrong sauce — always double-check the customer icon before finishing the box.</li>
  <li>Missing vegetables — skipping a side lowers your customer score.</li>
  <li>Over-preparing wrong boxes — wastes time and space in your prep line.</li>
</ul>
`,
  },

  {
    id: 'cookingdom-game-level-48',
    title: 'Cookingdom Level 48 Seafood Pasta Walkthrough',
    pageTitle: 'Cookingdom Level 48 Seafood Pasta Walkthrough',
    pageSubtitle:
      'Cook up flavorful Seafood Pasta in Level 48. Juggle boiling, sautéing, and plating to serve high-demand seafood dishes efficiently.',
    category: '41-50',
    publishDate: '2025-05-22',
    isSpecial: false,
    imageUrl: '/images/guides_48.webp', // Placeholder
    detailsRoute: { name: 'guide-detail', params: { id: 'cookingdom-game-level-48' } },
    ...
    sidebarData: {
      ...
      levelInfoHtml:
        '<h3>Cookingdom Level 48 <br/> Seafood Pasta</h3><p><strong>Difficulty:</strong> Medium-High</p><p><strong>Approx. Time:</strong> 3 mins</p><p><strong>Rewards:</strong> 4 Stars (Estimate)</p>',
      featuredGuides: [
        {
          id: 'cookingdom-game-level-47',
          title: 'Cookingdom Level 47 Lunch Box Walkthrough',
    ...
    detailsHtml: `
<h2 id="overview">Cookingdom Level 48 Game Overview</h2>
<p><strong>Cookingdom Level 48</strong> dives into rich flavors with <strong>Seafood Pasta</strong>. This level tests your ability to manage boiling pasta, sautéing seafood, and coordinating sauces while keeping customer satisfaction high.</p>

<h2 id="goal">🎯 Cookingdom Level 48 Goal</h2>
<ul>
  <li>Serve at least 22 seafood pasta dishes</li>
  <li>Keep satisfaction above 88%</li>
  <li>Complete within 3 minutes</li>
</ul>

<h2 id="ingredients">🍤 Cookingdom Level 48 Ingredients</h2>
<ul>
  <li>Spaghetti noodles</li>
  <li>Seafood mix: shrimp, squid, mussels</li>
  <li>Garlic butter sauce, tomato sauce</li>
  <li>Parsley garnish (optional bonus)</li>
  <li>Plates for serving</li>
</ul>

<h2 id="steps">👨‍🍳 Cookingdom Level 48 Step-by-Step Strategy</h2>
<ol>
  <li>Start by boiling the noodles — keep one pot running at all times.</li>
  <li>Sauté the correct seafood combination based on the order.</li>
  <li>Mix the cooked pasta and seafood with the selected sauce.</li>
  <li>Plate and serve quickly — use the parsley garnish for bonus points when requested.</li>
  <li>Queue the next pasta or seafood while the previous dish is cooking.</li>
</ol>

<h2 id="tips">🔥 Cookingdom Level 48 Pro Tips</h2>
<ul>
  <li><strong>Always boil ahead:</strong> Don’t wait for an order to start boiling pasta — pre-boil when possible.</li>
  <li><strong>Preheat the pan:</strong> Keep one sauté pan hot to reduce wait time between dishes.</li>
  <li><strong>Garnish boosts:</strong> Adding parsley when requested gives you bonus points and improves star rating.</li>
</ul>

<h2 id="mistakes">🚫 Common Mistakes in Level 48</h2>
<ul>
  <li>Undercooked pasta — don’t rush it or you'll lose points.</li>
