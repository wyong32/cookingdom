export const levels61to70 = [
  {
    ...
    "detailsHtml": `
        ...
        <p>I-grill at ihain ang iba't ibang mga barbecue dishes sa lahat ng mga customer bago matapos ang timer. Pansinin ang oras ng grilling at tiyaking tama ang paghahanda ng side dishes upang matugunan ang mga inaasahan ng customer.</p>
        
        <h2>Proseso ng Pagluluto</h2>
        
        <h3>Hakbang 1: Pumili ng mga Sangkap</h3>
        
        <ul>
          <li>Simulan sa pagpili ng karne o gulay na hinihiling ng customer. Kasama sa mga opsyon ang manok, baka, longganisa, at mga gulay tulad ng mais at bell peppers.</li>
          <li>I-drag ang napiling sangkap at ilagay ito sa grill upang simulan ang proseso ng pagluluto.</li>
        </ul>
        
        <h3>Hakbang 2: I-grill ang Karne o Gulay</h3>
        
        <ul>
          <li>Magmasid ng mabuti sa grill. Bawat sangkap ay may partikular na oras ng grilling—ang sobrang luto na pagkain ay mawawala ang lasa at magdudulot ng mababang rating.</li>
          <li>I-flip ang mga sangkap kung kinakailangan. Pansinin ang mga visual cues upang malaman kung kailan i-flip o alisin ang item mula sa grill.</li>
        </ul>
        
        <h3>Hakbang 3: Maghanda ng Side Dishes at Sauces</h3>
        
        <ul>
          <li>Bilang karagdagan sa grilling, kailangan mo ring maghanda ng mga side dish tulad ng baked potatoes, salad, at corn on the cob.</li>
          <li>Maghanda din ng mga kinakailangang sauces—barbecue sauce, ketchup, o spicy dip—ayon sa order ng customer.</li>
        </ul>
        
        <h3>Hakbang 4: Ihain</h3>
        
        <p>Kapag ang lahat ng mga sangkap ay naluto at ang mga side dish at sauces ay handa na, mabilis na ihain ang pagkain sa kaukulang customer. Ang mga pagkaantala o maling side dishes at sauces ay magreresulta sa mababang rating.</p>
        
        <h2>Mga Tip at Trik</h2>
        
        <ul>
          <li><strong>Oras ay Mahalaga:</strong> Subaybayan ang oras ng pagluluto ng bawat sangkap upang matiyak na ang lahat ay nai-grill ng perpekto.</li>
          <li><strong>Mag-multitask ng Epektibo:</strong> Habang nag-i-grill ng isang sangkap, magsimula ng paghahanda ng side dishes o sauces upang makatipid ng oras.</li>
          <li><strong>Pansinin ang mga Visual Cues:</strong> Ang grill ay may mga visual indicator na nagpapakita kung kailan luto na ang pagkain. I-flip o alisin ang mga item batay sa mga cues na ito.</li>
          <li><strong>Alamin ang mga Side Dishes at Sauces:</strong> Ang ilang mga customer ay humihiling ng partikular na side dishes o sauces. Tandaan ang mga ito upang mapabilis ang iyong workflow.</li>
          <li><strong>Panatilihing Tumpak ang mga Order:</strong> Siguraduhing wala kang nakalimutang mga sangkap o side dishes na in-order ng customer, dahil magdudulot ito ng mababang rating.</li>
        </ul>
...

  {
    ...
    "detailsHtml": `
        ...
        <p>Maghanda ng perpektong Campfire Beef Stew para sa bawat customer sa pamamagitan ng pagsunod sa eksaktong pagkakasunod-sunod ng pagluluto at paggamit ng tamang mga sangkap upang makuha ang pinakamataas na kasiyahan.</p>
        ...
        <ul>
          <li>Simulan sa pagpili ng karne ng baka at mga gulay—karot, patatas, sibuyas, at bawang—ayon sa order ng customer.</li>
          <li>Gupitin at ihanda ang mga sangkap, at gawing handa para sa mabagal na pagluluto.</li>
        </ul>
        
        <h3>Hakbang 2: Simulan ang Mabagal na Pagluluto</h3>
        
        <ul>
          <li>Ilagay ang karne ng baka at mga gulay sa isang malaking kaldero sa ibabaw ng campfire.</li>
          <li>Pakuluan ang stew ng dahan-dahan, binabantayan ang progreso ng pagluluto. Haluin paminsan-minsan upang maiwasan ang pagkasunog at matiyak ang pantay-pantay na pagluluto.</li>
        </ul>
        
        <h3>Hakbang 3: Magdagdag ng Pampalasa at Sabaw</h3>
        
        <ul>
          <li>Kapag ang karne ng baka ay malambot na, idagdag ang mga pampalasa at sabaw upang mapahusay ang lasa ng stew.</li>
          <li>Tiyaking magdagdag ng tamang halaga ng sabaw at pampalasa, dahil ang kulang ay magdudulot ng walang lasa na stew at ang sobra naman ay magiging malabnaw.</li>
        </ul>
        
        <h3>Hakbang 4: Panghuling Pagluluto</h3>
        
        <ul>
          <li>Hayaan ang stew na magluto pa ng ilang minuto. Magdagdag ng karagdagang mga halamang gamot o pampalasa upang mapalakas ang lasa.</li>
          <li>Kapag ang stew ay lutong-luto na, ihanda ang mangkok para ihain.</li>
        </ul>
        
        <h3>Hakbang 5: Ihain</h3>
        
        <p>Kapag ang stew ay handa na, ihain ito ng mainit sa customer. Siguraduhing ihain ito bago matapos ang oras upang mapanatili ang mataas na rating.</p>
        
        <h2>Mga Tip at Tricks</h2>
        
        <ul>
          <li><strong>Pamahalaan ang Mabagal na Pagluluto:</strong> Ang pasensya ay susi. Huwag magmadali sa mabagal na pagluluto dahil kailangan ng oras ang lasa upang magsanib. Maghalo paminsan-minsan upang matiyak na pantay-pantay ang pagluluto.</li>
          <li><strong>Panuorin ang Konsistensya ng Sabaw:</strong> Bantayan ang antas ng sabaw. Magdagdag ng higit pa kung mabilis itong naiiwanan, ngunit huwag sobrahan.</li>
          <li><strong>Oras ng Bawat Sangkap:</strong> Alamin kung paano nakikipag-ugnayan ang bawat sangkap sa proseso ng pagluluto. Ang ibang gulay ay nangangailangan ng mas matagal na oras upang lumambot.</li>
          <li><strong>Maging Mabilis Mag-multitask:</strong> Habang hinihintay ang stew na magluto, gamitin ang oras na iyon upang maghanda ng ibang mga pagkain o mag-stock ng mga sangkap para sa susunod na batch ng stew.</li>
          <li><strong>Tandaan ang mga Pagpipilian ng Customer:</strong> Ang ilang mga customer ay may paboritong higit na sabaw o partikular na pampalasa. Tandaan ang mga detalye na ito upang maiwasan ang mga pagkakamali.</li>
        </ul>
...

  {
    ...
    "detailsHtml": `
        ...
        <p>Grill a variety of meats and seafood, add sides like corn, coleslaw, and baked potatoes, and serve the customers before the time runs out to achieve the highest rating.</p>
        
        <h2>Cooking Process</h2>
        
        <h3>Step 1: Choose the Ingredients</h3>
        
        <ul>
          <li>Select the right type of meat or seafood for the customer’s order—options include chicken, pork, shrimp, or fish fillets.</li>
          <li>Drag and drop the ingredients onto the grill to start cooking. Be mindful of the grilling time to avoid overcooking.</li>
        </ul>
        
        <h3>Step 2: Grill the Meats and Seafood</h3>
        
        <ul>
          <li>Watch the grilling process closely. Seafood cooks quickly, while meat may take a bit longer. Flip items when prompted by visual cues to ensure even cooking.</li>
          <li>Use the grill's heat control to adjust the cooking speed if necessary—too hot and the food burns, too low and it takes too long to cook.</li>
        </ul>
        
        <h3>Step 3: Prepare the Sides</h3>
        
        <ul>
          <li>While grilling, prepare the side dishes, such as corn on the cob, coleslaw, or baked potatoes. Some customers may request specific sides, so make sure you’re prepared.</li>
          <li>Place the sides on the serving plates as soon as they’re ready. These need to be served along with the grilled items.</li>
        </ul>
        
        <h3>Step 4: Serve the Meal</h3>
        
        <p>Once everything is ready, serve the grilled meats, seafood, and sides to the customer. Be quick—delays will affect your rating, and missing an item will result in a lower score.</p>
        
        <h2>Tips and Tricks</h2>
        
        <ul>
          <li><strong>Master Grilling Times:</strong> Different items cook at different speeds. Keep track of each item on the grill and flip them at the right time.</li>
          <li><strong>Control Grill Heat:</strong> Adjust the heat for the optimal cooking speed. High heat is great for searing meats, while low heat is perfect for seafood.</li>
          <li><strong>Side Dish Efficiency:</strong> While grilling, quickly prepare the sides to avoid wasting time. Keep the sides simple and ready to serve.</li>
          <li><strong>Watch for Customer Preferences:</strong> Pay attention to special requests for sides or specific grilling methods (e.g., well-done or medium-rare). Knowing customer preferences will help you avoid mistakes.</li>
          <li><strong>Stay Organized:</strong> Keep the grilling and side preparations organized. Start grilling the next item while finishing the sides for the previous one.</li>
        </ul>
...

  {
    ...
    "detailsHtml": `
        ...
        <p>Prepara una variedad de pedidos de Dimsum, incluyendo empanadillas y bollos al vapor, y sírvelos a los clientes antes de que se acabe el tiempo. La precisión y el tiempo son clave para lograr la mejor calificación.</p>
        
        <h2>Proceso de Cocina</h2>
        
        <h3>Paso 1: Preparar la Masa del Dimsum</h3>
        
        <ul>
          <li>Comienza preparando la masa para las envolturas de Dimsum. Elige el tipo correcto según el pedido: envolturas para empanadillas o masa para bollos al vapor.</li>
          <li>Pon la masa sobre la mesa y usa el rodillo para estirarla.</li>
        </ul>
        
        <h3>Paso 2: Agregar el Relleno</h3>
        
        <ul>
          <li>Elige el relleno adecuado para el pedido del cliente: opciones incluyen cerdo, camarones, vegetales o una mezcla de estos.</li>
          <li>Pon el relleno en el centro de la masa y dóblala con cuidado para formar una empanadilla o bollo. Asegúrate de no sobrecargarlo, ya que esto puede hacer que se rompa durante el vapor.</li>
        </ul>
        
        <h3>Paso 3: Cocer al Vapor el Dimsum</h3>
        
        <ul>
          <li>Pon las empanadillas o bollos formados en una canasta para vapor y transfiérelos al vaporizador.</li>
          <li>Controla el tiempo de cocción. Si es demasiado corto, el Dimsum quedará crudo; si es demasiado largo, perderá su textura delicada.</li>
        </ul>
        
        <h3>Paso 4: Servir el Dimsum</h3>
        
        <p>Una vez que el Dimsum esté cocido al vapor a la perfección, ponlo en el plato de servicio y entregalo al cliente. Sé rápido, ya que las demoras pueden reducir tu calificación.</p>
        
        <h2>Consejos y Trucos</h2>
        
        <ul>
          <li><strong>Domina los Tiempos de Cocción al Vapor:</strong> Cocer al vapor es la parte más crítica. Mantén un seguimiento de tu vaporizador, ya que el tiempo de cocción de los diferentes tipos de Dimsum puede variar.</li>
          <li><strong>Usa Señales Visuales:</strong> Presta atención a las señales visuales para saber cuándo el Dimsum está listo. Los vaporizadores mostrarán un indicador cuando el proceso de cocción haya terminado.</li>
          <li><strong>Manejo Eficiente de la Masa:</strong> No pierdas tiempo estirando la masa. Prepara varias estaciones de trabajo y haz lotes para acelerar la preparación.</li>
          <li><strong>Multitarea:</strong> Mientras el Dimsum se está cociendo al vapor, empieza a preparar el siguiente lote o a hacer el relleno para el próximo pedido para acelerar tu flujo de trabajo.</li>
          <li><strong>Precisión con los Rellenos:</strong> Ten cuidado con la cantidad de relleno que usas. Las empanadillas demasiado rellenas pueden romperse, y si usas poco relleno, el plato será decepcionante.</li>
        </ul>
