export const levels61to70 = [
  {
    ...
    "detailsHtml": `
        ...
        <p>Panggang dan hidangkan pelbagai hidangan BBQ kepada semua pelanggan dalam masa yang ditetapkan. Perhatikan masa memanggang dan pastikan hidangan sampingan disediakan dengan betul untuk memenuhi jangkaan pelanggan.</p>
        
        <h2>Proses Memasak</h2>
        
        <h3>Langkah 1: Pilih Bahan</h3>
        
        <ul>
          <li>Mulakan dengan memilih daging atau sayur-sayuran yang diminta oleh pelanggan. Pilihan termasuk ayam, daging lembu, sosej, dan sayur-sayuran seperti jagung dan lada benggala.</li>
          <li>Seret bahan yang dipilih ke atas panggangan dan mulakan proses memanggang.</li>
        </ul>
        
        <h3>Langkah 2: Panggang Daging atau Sayur</h3>
        
        <ul>
          <li>Perhatikan dengan teliti proses memanggang. Setiap bahan memerlukan masa memanggang tertentu—makanan yang terlebih masak akan kehilangan rasa dan menyebabkan penarafan rendah.</li>
          <li>Terbalikkan bahan apabila perlu. Perhatikan isyarat visual untuk mengetahui bila perlu terbalikkan atau keluarkan bahan dari panggangan.</li>
        </ul>
        
        <h3>Langkah 3: Sediakan Hidangan Sampingan dan Sos</h3>
        
        <ul>
          <li>Selain memanggang, anda perlu menyediakan hidangan sampingan seperti kentang bakar, salad, dan jagung bakar.</li>
          <li>Juga, sediakan sos yang diperlukan—sos BBQ, sos tomato, atau sos pedas—mengikut pesanan pelanggan.</li>
        </ul>
        
        <h3>Langkah 4: Hidangkan</h3>
        
        <p>Setelah semuanya dipanggang dan hidangan sampingan serta sos disediakan, hidangkan dengan cepat kepada pelanggan yang sesuai. Kelewatan atau hidangan sampingan serta sos yang salah akan menyebabkan penarafan lebih rendah.</p>
        
        <h2>Petua dan Trik</h2>
        
        <ul>
          <li><strong>Waktu adalah kunci:</strong> Jejak masa memanggang setiap bahan untuk memastikan semuanya dipanggang dengan sempurna.</li>
          <li><strong>Multitasking dengan efisien:</strong> Semasa memanggang satu bahan, mulakan persediaan untuk hidangan sampingan atau sos untuk menjimatkan masa.</li>
          <li><strong>Perhatikan isyarat visual:</strong> Panggang mempunyai isyarat visual yang menunjukkan bila makanan sudah masak. Terbalikkan atau keluarkan bahan berdasarkan isyarat ini.</li>
          <li><strong>Ingat hidangan sampingan dan sos:</strong> Sesetengah pelanggan meminta hidangan sampingan atau sos tertentu. Ingat keutamaan mereka untuk mempercepatkan kerja anda.</li>
          <li><strong>Perhatikan pesanan:</strong> Pastikan anda tidak terlupa bahan atau hidangan sampingan yang diminta oleh pelanggan, kerana ini akan mengurangkan penarafan.</li>
        </ul>
...

  {
    ...
    "detailsHtml": `
        ...
        <p>Siapkan Stew Daging Api Perkemahan yang sempurna untuk setiap pelanggan dengan mengikuti urutan memasak yang tepat dan menggunakan bahan yang betul untuk memaksimumkan kepuasan pelanggan.</p>
        ...
        <ul>
          <li>Mulakan dengan memilih daging dan sayuran—lobak merah, kentang, bawang, dan bawang putih—mengikut pesanan pelanggan.</li>
          <li>Potong dan sediakan bahan-bahan, dan bersedia untuk memasak perlahan.</li>
        </ul>
        
        <h3>Langkah 2: Mulakan Memasak Perlahan</h3>
        
        <ul>
          <li>Letakkan daging dan sayuran dalam periuk besar di atas api perkemahan.</li>
          <li>Masak stew perlahan-lahan, sambil memantau kemajuan memasak. Kacau sesekali untuk mengelakkan makanan daripada hangus dan memastikan ia dimasak sekata.</li>
        </ul>
        
        <h3>Langkah 3: Tambah Perasa dan Kuah</h3>
        
        <ul>
          <li>Apabila daging sudah empuk, tambahkan perasa dan kuah untuk meningkatkan rasa stew.</li>
          <li>Pastikan untuk menambah kuah dan rempah yang betul, kerana terlalu sedikit akan menyebabkan stew menjadi tawar, manakala terlalu banyak akan menjadikannya cair.</li>
        </ul>
        
        <h3>Langkah 4: Fasa Memasak Akhir</h3>
        
        <ul>
          <li>Biarkan stew memasak untuk beberapa minit terakhir. Tambahkan herba atau perasa tambahan untuk meningkatkan rasa.</li>
          <li>Apabila stew dimasak dengan sempurna, sediakan mangkuk untuk dihidangkan.</li>
        </ul>
        
        <h3>Langkah 5: Hidangkan</h3>
        
        <p>Apabila stew siap sepenuhnya, hidangkan dengan segera kepada pelanggan. Pastikan untuk menyampaikannya sebelum masa tamat untuk mengekalkan penarafan yang tinggi.</p>
        
        <h2>Petua dan Trik</h2>
        
        <ul>
          <li><strong>Pengurusan Memasak Perlahan:</strong> Kesabaran adalah kunci. Jangan terburu-buru dalam proses memasak perlahan kerana rasa memerlukan masa untuk berkembang. Kacau secara berkala untuk memastikan semuanya dimasak sekata.</li>
          <li><strong>Perhatikan Konsistensi Kuah:</strong> Perhatikan tahap kuah. Tambahkan lebih jika ia cepat menguap, tetapi jangan terlalu banyak.</li>
          <li><strong>Waktu Bahan:</strong> Ambil perhatian tentang bagaimana setiap bahan berinteraksi semasa memasak. Sesetengah sayuran memerlukan lebih banyak masa untuk melembutkan daripada yang lain.</li>
          <li><strong>Multitask dengan Bijak:</strong> Semasa menunggu stew untuk dimasak, gunakan masa itu untuk menyediakan hidangan lain atau stok bahan-bahan untuk batch stew seterusnya.</li>
          <li><strong>Perhatikan Pilihan Pelanggan:</strong> Sesetengah pelanggan lebih suka kuah lebih banyak atau rempah tertentu. Rekodkan pilihan ini untuk mengelakkan kesilapan.</li>
        </ul>
...

  {
    ...
    "detailsHtml": `
        ...
        <p>Memanggang pelbagai jenis daging dan makanan laut, menambah sisi seperti jagung, salad, dan kentang bakar, dan hidangkan kepada pelanggan sebelum masa tamat untuk mencapai penarafan tertinggi.</p>
        ...
        <ul>
          <li>Pilih jenis daging atau makanan laut yang tepat untuk pesanan pelanggan — pilihan termasuk ayam, daging babi, udang, atau fillet ikan.</li>
          <li>Seret dan lepaskan bahan yang dipilih ke atas grill untuk memulakan proses memasak. Perhatikan masa memanggang untuk mengelakkan memasak terlalu lama.</li>
        </ul>
        
        <h3>Langkah 2: Memanggang Daging dan Makanan Laut</h3>
        
        <ul>
          <li>Perhatikan proses memasak dengan teliti. Makanan laut dimasak dengan cepat, manakala daging memerlukan sedikit masa lebih lama. Terbalikkan bahan apabila diarahkan oleh petunjuk visual untuk memastikan ia dimasak secara merata.</li>
          <li>Gunakan kawalan haba grill untuk menyesuaikan kelajuan memasak jika perlu — terlalu panas dan makanan akan terbakar, terlalu rendah dan ia mengambil masa yang terlalu lama untuk dimasak.</li>
        </ul>
        
        <h3>Langkah 3: Sediakan Sisi</h3>
        
        <ul>
          <li>Sambil memanggang, sediakan sisi seperti jagung bakar, salad, atau kentang bakar. Beberapa pelanggan mungkin meminta sisi tertentu, jadi pastikan anda bersedia.</li>
          <li>Apabila sisi siap, letakkan pada pinggan penyajian dengan segera. Ia perlu disajikan bersama-sama dengan makanan yang dipanggang.</li>
        </ul>
        
        <h3>Langkah 4: Hidangkan Makanan</h3>
        
        <p>Apabila semuanya siap, hidangkan daging yang dipanggang, makanan laut, dan sisi kepada pelanggan. Lakukan dengan cepat — kelewatan akan mempengaruhi penarafan anda, dan kekurangan bahan akan mengakibatkan penurunan skor.</p>
        
        <h2>Petua dan Trik</h2>
        
        <ul>
          <li><strong>Kuasa Masa Memanggang:</strong> Setiap bahan dimasak pada masa yang berbeza. Jejaki setiap bahan di grill dan terbalikkan pada masa yang betul.</li>
          <li><strong>Kawal Haba Grill:</strong> Sesuaikan haba untuk kelajuan memasak yang optimum. Haba tinggi sesuai untuk menggoreng daging, manakala haba rendah sesuai untuk makanan laut.</li>
          <li><strong>Kecekapan Sediakan Sisi:</strong> Sambil memanggang, cepat sediakan sisi untuk mengelakkan pembaziran masa. Pastikan sisi yang disediakan mudah dan siap sedia untuk dihidangkan.</li>
          <li><strong>Perhatikan Keutamaan Pelanggan:</strong> Ambil perhatian terhadap permintaan khas pelanggan untuk sisi atau cara memanggang tertentu (contohnya, masak sepenuhnya atau separuh masak). Mengetahui keutamaan pelanggan akan membantu mengelakkan kesilapan.</li>
          <li><strong>Terus Teratur:</strong> Pastikan proses memanggang dan penyediaan sisi teratur. Mulakan memanggang bahan seterusnya sambil menyelesaikan sisi untuk yang sebelumnya.</li>
        </ul>
...

  {
    ...
    "detailsHtml": `
        ...
        <p>Sediakan pelbagai pesanan Dimsum, termasuk dumpling dan bun kukus, dan sajikan kepada pelanggan sebelum masa tamat. Ketepatan dan masa adalah kunci untuk mendapatkan penarafan tertinggi.</p>
        
        <h2>Proses Memasak</h2>
        
        <h3>Langkah 1: Sediakan Doh Dimsum</h3>
        
        <ul>
          <li>Mulakan dengan menyediakan doh untuk pembalut Dimsum. Pilih jenis yang betul berdasarkan pesanan—doh untuk dumpling atau bun kukus.</li>
          <li>Letakkan doh di atas meja dan gunakan penggulung doh untuk meratakannya.</li>
        </ul>
        
        <h3>Langkah 2: Tambahkan Inti</h3>
        
        <ul>
          <li>Pilih inti yang betul untuk pesanan pelanggan—pilihan termasuk daging babi, udang, sayur-sayuran, atau campurannya.</li>
          <li>Letakkan inti di tengah doh, dan lipat dengan kemas menjadi bentuk dumpling atau bun. Pastikan tidak terlalu banyak inti, kerana ini boleh menyebabkan ia pecah semasa dikukus.</li>
        </ul>
        
        <h3>Langkah 3: Kukus Dimsum</h3>
        
        <ul>
          <li>Letakkan dumpling atau bun yang telah dibentuk ke dalam bakul pengukus dan pindahkan ke dalam pengukus.</li>
          <li>Perhatikan masa memasak. Jika terlalu singkat, Dimsum akan mentah; jika terlalu lama, ia akan kehilangan tekstur yang lembut.</li>
        </ul>
        
        <h3>Langkah 4: Hidangkan Dimsum</h3>
        
        <p>Setelah Dimsum dikukus sempurna, letakkan di atas pinggan hidang dan serahkan kepada pelanggan. Bertindak cepat—kelewatan boleh menyebabkan penarafan rendah.</p>
        
        <h2>Petua dan Trik</h2>
        
        <ul>
          <li><strong>Kuasa Masa Mengukus:</strong> Mengukus adalah bahagian yang paling kritikal. Perhatikan pengukus dengan teliti, kerana masa mengukus untuk setiap jenis Dimsum boleh berbeza.</li>
          <li><strong>Gunakan Petunjuk Visual:</strong> Perhatikan petunjuk visual untuk mengetahui bila Dimsum sudah siap. Pengukus akan menunjukkan indikator apabila proses pengukusan selesai.</li>
          <li><strong>Kendali Doh dengan Efisien:</strong> Jangan buang masa menguli doh. Sediakan beberapa stesen kerja dan lakukan dalam kumpulan untuk mempercepatkan penyediaan.</li>
          <li><strong>Bekerja dalam Beberapa Tugas:</strong> Sementara Dimsum dikukus, mulakan penyediaan kumpulan seterusnya atau sediakan inti untuk pesanan berikutnya bagi mempercepatkan aliran kerja anda.</li>
          <li><strong>Ketepatan dengan Inti:</strong> Berhati-hati dengan jumlah inti yang digunakan. Dumpling yang berisi terlalu banyak inti boleh pecah, sementara inti yang terlalu sedikit akan mengecewakan pelanggan.</li>
        </ul>
