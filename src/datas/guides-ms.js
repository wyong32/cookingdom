export const guides = [
  {
    ...
    seo: {
      title: 'Panduan Cookingdom Level 1 - Pizza Pertama',
      description:
        'Pelajari cara menyediakan, membakar, dan menyajikan pizza pertama anda di Cookingdom Level 1. Fahami asas memasak dan perkhidmatan pelanggan.',
      keywords: 'cookingdom, level 1, pizza pertama, panduan, asas, tutorial',
    },
    sidebarData: {
      sidebarImageUrl: '/images/guides_01.webp',
      levelInfoHtml:
        '<h3>Pizza Pertama</h3><p><strong>Kesukaran:</strong> Mudah</p><p><strong>Anggaran Masa:</strong> 1 minit</p><p><strong>Ganjaran:</strong> 3 Bintang</p>',
      featuredGuides: [
        {
...
<p>Di Level 1 Cookingdom, pemain belajar bagaimana membuat dan menyajikan pizza, salah satu hidangan asas dalam permainan. Level ini bertujuan untuk membiasakan pemain dengan proses memasak, penyediaan bahan-bahan, dan ritma asas operasi restoran.</p>
<h2>Matlamat Level 1</h2>
<p>Anda akan diminta untuk membuat dan menyajikan pizza pertama kepada pelanggan. Membuat pizza melibatkan beberapa langkah, termasuk penyediaan bahan, pembakaran, dan penyajian. Matlamatnya adalah untuk memenuhi keperluan pelanggan dengan cepat dan tepat untuk menyelesaikan tugas.</p>
<h2>Proses Membuat Pizza</h2>
<h3>Penyediaan Bahan Pizza:</h3>
<p>Pertama, kumpulkan bahan-bahan asas: dasar pizza, sos tomato, keju, dan topping lain (seperti sosej, cendawan).</p>
<ul>
  <li><strong>Dasar Pizza:</strong> Ambil dasar pizza dari kawasan bahan.</li>
  <li><strong>Sos Tomato:</strong> Sebarkan sos tomato dengan sekata pada dasar pizza.</li>
  <li><strong>Keju:</strong> Taburkan keju dengan sekata.</li>
</ul>
<h3>Menambah Topping:</h3>
<p>Di Level 1, topping adalah mudah. Gunakan topping asas seperti sosej atau cendawan.</p>
<ul>
  <li>Seret topping ke atas pizza, pastikan pengagihan sekata. Ini meningkatkan rasa dan kepuasan pelanggan.</li>
</ul>
<h3>Membakar Pizza:</h3>
<p>Letakkan pizza yang telah disediakan ke dalam ketuhar.</p>
<p><strong>Nota:</strong> Masa pembakaran adalah penting. Pembakaran berlebihan akan membakar pizza; kekurangan masa akan menyebabkan pizza mentah.</p>
<p>Pantau kemajuan pizza dengan teliti semasa membakar untuk memastikan warna dan tekstur yang sempurna.</p>
<h3>Memeriksa Kematangan Pizza:</h3>
<p>Perhatikan penampilan pizza. Apabila ia bertukar menjadi perang keemasan dan berbau wangi, ia sudah siap.</p>
<p>Pizza yang terlalu dibakar menjadi hangus dan rasanya tidak enak, yang boleh mengecewakan pelanggan.</p>
<h3>Menyajikan Pizza:</h3>
<p>Keluarkan pizza yang telah dibakar dari ketuhar dan segera hantar ke meja pelanggan.</p>
<p>Masa adalah penting: Tunggu terlalu lama akan menurunkan kepuasan pelanggan, yang mempengaruhi markah dan ganjaran anda.</p>
<h2>Petua dan Trik</h2>
<ul>
  <li><strong>Pengurusan Masa:</strong> Belajar menguruskan masa, terutamanya dengan memasak dan penyediaan. Kawalan ketuhar yang tepat diperlukan.</li>
  <li><strong>Penyediaan Bahan Awal:</strong> Sementara menunggu pizza dibakar, sediakan bahan-bahan lain atau bersihkan dapur. Sediakan lebih awal untuk penyajian yang lebih cepat.</li>
  <li><strong>Operasi Ketuhar:</strong> Biasakan diri dengan ketuhar. Setiap makanan mempunyai masa pembakaran yang berbeza; kuasai masa-masa tersebut.</li>
  <li><strong>Kesabaran Pelanggan:</strong> Tunggu lama akan mengurangkan kesabaran dan markah pelanggan. Percepatkan perkhidmatan.</li>
  <li><strong>Latihan Multitasking:</strong> Sambil membakar, sediakan item lain atau bersihkan untuk meningkatkan kecekapan. Level-level yang lebih tinggi mempunyai lebih banyak pelanggan dan hidangan, jadi latihan membantu.</li>
</ul>
<h2>Ringkasan</h2>
<p>Membuat pizza pertama adalah tugas pengenalan dalam Cookingdom. Ia membiasakan anda dengan asas memasak dan penyajian, pengurusan bahan, kawalan masa memasak, dan keperluan pelanggan. Matlamatnya adalah untuk memahami asas pengurusan masa dan kemahiran penyediaan untuk level yang lebih kompleks yang akan datang.</p>
<p>Menyelesaikan Level 1 memberi ganjaran syiling dan markah, membuka lebih banyak peralatan dapur dan resipi untuk pengalaman permainan yang lebih kaya.</p>`,
  },
  {
    id: 'cookingdom-game-level-2',
    title: 'Cookingdom Level 2<br />Salad Sederhana',
